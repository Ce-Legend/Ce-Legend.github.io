  ...
  return (
    <main>
      ...
      <section id="top" className="hero-section">
        ...
        <figure className="orchard-map">
          <img src="/assets/orchard-map.png" alt="个人长期复利果园地图" />
        </figure>
      </section>
      ...
      <section id="work" className="section work-section">
        ...
        <div className="work-list">
          <a href="#work">数据交付体系</a>
          <a href="#work">短视频评论采集</a>
          <a href="#work">企业信息采集</a>
          <a href="#work">光网络可视化平台</a>
          <a href="#work">AI 思维工具站</a>
        </div>
      </section>
